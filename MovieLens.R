...
#RMSE=1.0612, not the desired value
...
#Testing with the validation set and using a correction of NAs, minimum and maximum values
...
#Calculating the effect of the movies regularized
#Finding lambda
...
#To see how the estimates change
