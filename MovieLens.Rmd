...
---
[//]: # "The .tex file is used to make the plots stay in their position when knit to pdf, is the only way I found to achieve this, otherwise, the plots where in the wrong places. The .tex is in the GitHub's repository"
