...
```
 ...
 Using the validation set and using a correction of minimum and maximum values to obtain the RMSE of the algorithm:  
```{r warning=FALSE,message=FALSE}
...
```
 ...
 Using the validation set with the final model and using a correction of minimum and maximum values:  
```{r warning=FALSE,message=FALSE}
